...
from Defect_analyzer_front.defect_app.posts_default.forms import PostForm

posts = Blueprint('posts_default', __name__)
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('posts_default.post', post_id=post.id))
