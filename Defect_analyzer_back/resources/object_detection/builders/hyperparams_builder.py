...
class KerasLayerHyperparams(object):
  ...
  def __init__(self, hyperparams_config):
    ...
    It automatically converts from Slim layer hyperparameter config to
...
def _build_batch_norm_params(batch_norm, is_training):
  ...
  Args:
    ...
    is_training: Whether the classes is in training mode.
  ...
  batch_norm_params = {
      ...
      # once we refactor Faster RCNN classes to set is_training through an outer
