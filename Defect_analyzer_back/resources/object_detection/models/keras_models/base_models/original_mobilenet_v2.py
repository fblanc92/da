...
"""MobileNet v2 classes for Keras.

MobileNetV2 is a general architecture and can be used for multiple use cases.
Depending on the use case, it can use different input layer size and
different width factors. This allows different width classes to reduce
...
all 22 classes from the paper can be built, with ImageNet weights provided.
...
The weights for all 16 classes are obtained and translated from the Tensorflow
...
def mobilenet_v2(input_shape=None,
  ...
  if K.image_data_format() != 'channels_last':
    warnings.warn('The MobileNet family of classes is only available '
