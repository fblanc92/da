...
This file defines a generic base class for detection classes.  Programs that are
designed to work with arbitrary detection classes should only depend on this
...
Abstractly, detection classes predict output tensors given input images
...
# If using a new enough version of TensorFlow, detection classes should be a
...
class DetectionModel(six.with_metaclass(abc.ABCMeta, _BaseClass)):
  """Abstract base class for detection classes.
