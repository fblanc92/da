...
def train_loop(
  ...
  This method:
    1. Processes the pipeline config
  ...
  # Parse the checkpoint fine tuning config
...
def eager_eval_loop(
  ...
  This method will compute the evaluation metrics specified in the config on
  ...
  Args:
    ...
    configs: Object detection config that specify the evaluators that should
